...
class CommandBuffer {
 public:
  ...
  // Performs image layout transition from |image current layout| to |to_layout| of the
  // given |image|.
  absl::Status TransitionImageLayout(Image &image,
  ...
  absl::Status AddTransitionImageLayout(Image &image, VkImageLayout to_layout, std::vector<PipelineBarrierInfo>& barriers_info);

  void TransitionImageLayout(std::vector<PipelineBarrierInfo>& barriers_info);
