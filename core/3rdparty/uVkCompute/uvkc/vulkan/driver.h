...
class Driver {
 public:
  ...
  // Creates a Vulkan driver from external Vulkan data
  static absl::StatusOr<std::unique_ptr<Driver>> CreateExternally(
 ...
 private:
  explicit Driver(VkInstance instance, const DynamicSymbols &symbols, bool externallyOwned = false);
