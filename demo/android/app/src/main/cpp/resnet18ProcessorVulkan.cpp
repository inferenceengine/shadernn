...
ResNet18ProcessorVulkan::ResNet18ProcessorVulkan(ColorFormat format, Precision precision, bool dumpOutputs)
        : ResNet18Processor(format, precision, false, dumpOutputs)
{}

void ResNet18ProcessorVulkan::init(const FrameDims& inputDims_, const FrameDims& outputDims_) {
    ...
    genericModelProcessorVulkan.reset(new GenericModelProcessorVulkan(*this,
        ...
        0.5f, // modelInputMean_
        2.0f, // modelInputNorm_
