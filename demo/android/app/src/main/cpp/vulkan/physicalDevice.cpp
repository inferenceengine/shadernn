    ...
    handle{physical_device}
{
    ...
    SNN_LOGI("Found GPU: %s", properties.deviceName);
...
// VkQueryPoolPerformanceCreateInfoKHR is not declared on volk loader
#if 0
...
// VkPerformanceCounterKHR is not declared on volk loader
#if 0
