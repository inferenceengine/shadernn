...
class StyleTransferProcessorVulkan : public StyleTransferProcessor {
public:
    StyleTransferProcessorVulkan(ColorFormat format, const std::string& modelFileName, Precision precision, bool dumpOutputs);
    virtual ~StyleTransferProcessorVulkan() = default;
