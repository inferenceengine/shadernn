...
class ResNet18ProcessorVulkan : public ResNet18Processor {
public:
    ResNet18ProcessorVulkan(ColorFormat format, Precision precision, bool dumpOutputs);
    virtual ~ResNet18ProcessorVulkan() = default;
