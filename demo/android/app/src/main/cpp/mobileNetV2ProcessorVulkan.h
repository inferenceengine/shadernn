...
class MobileNetV2ProcessorVulkan : public MobileNetV2Processor {
public:
    MobileNetV2ProcessorVulkan(ColorFormat format, Precision precision, bool dumpOutputs);
    virtual ~MobileNetV2ProcessorVulkan() = default;
